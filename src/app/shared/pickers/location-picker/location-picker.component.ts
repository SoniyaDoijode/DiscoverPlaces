...
export class LocationPickerComponent implements OnInit {
  ...
  private getAddress(lat: number, lng: number) {
    return this.http
      .get(
        `https://api.mapbox.com/geocoding/v5/mapbox.places/${lat},${lng}.json?access_token=pk.eyJ1Ijoic29uaXlhZG9pam9kZSIsImEiOiJjazh4NHV4djEwMnhxM2VuNXMzMGtpeXY1In0.YBpDrjpYA0XMAcJxTeq2ng`
      )
      .pipe(
        map((geoData: any) => {
